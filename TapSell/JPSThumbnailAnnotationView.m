...
static CGFloat const kJPSThumbnailAnnotationViewExpandOffset      = 220.0f;
...
- (void)setupDisclosureButton {
    ...
    UIImage *disclosureIndicatorImage = [UIImage imageNamed:@"tapit.png"];
    NSLog(@"%@",disclosureIndicatorImage);

    [_disclosureButton setBackgroundImage:disclosureIndicatorImage forState:UIControlStateNormal];
    
    
    
    _disclosureButton.frame = CGRectMake(kJPSThumbnailAnnotationViewExpandOffset/2.5f + self.frame.size.width/2.0f + 10.0f,
                                         15.0f,
                                         disclosureIndicatorImage.size.width/7.0f,
                                         disclosureIndicatorImage.size.height/7.0f);
